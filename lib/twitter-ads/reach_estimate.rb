...
module TwitterAds
  module ReachEstimate
    ...
    class << self
      ...
      #
      # @example
      #   TwitterAds::ReachEstimate.get_reach_estimate(
      #     CLIENT, account, "ALL_ON_TWITTER", "PROMOTED_TWEETS", "WEBSITE_CLICKS",
      #     12, similar_to_followers_of_user: "12", gender: "2")
      #
      ...
      def get_reach_estimate(client, account, product_type,
                             objective, user_id, opts = {})
        ...
        response = TwitterAds::Request.new(
          client, :get, resource, params: params.merge(opts)).perform
        response.body[:data]
      end
